...
public class TextRecord implements ParsedNdefRecord {
	...
	// TODO: deal with text fields which span multiple NdefRecord
	public static TextRecord parse(NdefRecord record) {
		...
		try {
			 ...
			 * 
			 * if (Bit_7 == 0): The text is encoding in UTF-8 if (Bit_7 == 1):
			 * The text is encoding in UTF16
			 * 
			 * bit6 is reserved for future use and must be set to zero.
			 * 
