...
import com.androhi.nfctest.NdefMessageParser;
import com.androhi.nfctest.R;
...
/**
 * A representation of an NFC Forum "SmartPoster".
 * @author androhi
 *
 */
public class SmartPoster implements ParsedNdefRecord {
	 ...
	 * NFC Forum Smart Poster Record Type Definition section 3.2.1.
	 * 
	 * "The Action record. This record describes how the service shold be
	 * treated. For example, the action may indicate that the device shold save
	 ...
	 * If the action record exists, it shold be treated as a strong suggestion;
	 * the UI designer may ignore it, but doing so will induce a diffrent user
	 ...
	 * URL), the Type record may be used to declare the MINE type of the entity.
